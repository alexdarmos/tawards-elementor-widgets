...
final class Elementor_Tawards {
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( Elementor_Tawards ) );
...
// Instantiate Elementor_Tawards.
new Elementor_Tawards();
